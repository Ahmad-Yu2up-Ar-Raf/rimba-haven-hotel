      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-10 px-4 py-16 md:flex-row md:justify-between md:px-8">
        <div className="flex max-w-sm flex-col gap-4">
          <div className="flex items-center gap-2.5">
            <img src="/assets/logo/rh-mark.svg" alt="" className="size-8 text-gold-400" />
        ...
        <nav aria-label="Navigasi bawah" className="flex flex-col gap-2 text-sm">
          <span className="text-xs font-semibold tracking-[0.2em] text-gold-400 uppercase">Jelajah</span>
        ...
        <div className="flex flex-col gap-2 text-sm">
          <span className="text-xs font-semibold tracking-[0.2em] text-gold-400 uppercase">Kontak</span>
